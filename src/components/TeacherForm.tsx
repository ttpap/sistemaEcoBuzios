          ...
          <CardContent className="p-8">
            ...
            <div className="grid gap-6 md:grid-cols-3">
              <FormField control={form.control} name="fullName" render={({ field }) => (
                <FormItem className="md:col-span-3"><FormLabel className="font-bold">Nome Completo / Razão Social *</FormLabel><FormControl><Input {...field} className="rounded-xl" /></FormControl><FormMessage /></FormItem>
              )} />
              ...
              <FormField control={form.control} name="cnpj" render={({ field }) => (
                <FormItem><FormLabel className="font-bold">CNPJ (caso Pessoa Jurídica)</FormLabel><FormControl><Input placeholder="00.000.000/0000-00" {...field} className="rounded-xl" /></FormControl></FormItem>
              )} />
          ...
          <CardContent className="p-8">
            ...
            <div className="grid gap-6 md:grid-cols-4">
              ...
              <FormField control={form.control} name="complement" render={({ field }) => (
                <FormItem className="md:col-span-2"><FormLabel className="font-bold">Complemento</FormLabel><FormControl><Input {...field} className="rounded-xl" /></FormControl></FormItem>
              )} />
