                          ...
                          <div key={student.id} className="p-4 bg-white rounded-2xl border border-slate-100 flex items-center justify-between">
                            <div className="flex items-center gap-3 min-w-0">
                              <StudentAvatar
                                ...
                                className="w-10 h-10 rounded-2xl bg-secondary/15 border border-secondary/20 flex items-center justify-center font-black text-primary shrink-0 overflow-hidden"
                              />
                      ...
                      <div key={s.id} className="flex items-center justify-between p-4 bg-slate-50 rounded-2xl border border-slate-100 group">
                        <div className="flex items-center gap-3 min-w-0">
                          <StudentAvatar
                            ...
                            className="w-8 h-8 rounded-lg bg-secondary/20 flex items-center justify-center text-primary font-black text-xs shrink-0 overflow-hidden"
                          />
                          <div className="min-w-0">
        ...
        {base === "" && (
          <TabsContent value="dashboard" className="mt-6">
            ...
            <div className="flex items-center gap-2 mb-6">
              <p className="text-xs font-black uppercase tracking-widest text-slate-400 mr-2">Ver como:</p>
              <button
                type="button"
                onClick={() => setDashboardRole("professor")}
                className={`rounded-2xl px-4 py-2 text-sm font-black border transition-colors ${
              ...
              <button
                type="button"
                onClick={() => setDashboardRole("coordenador")}
                className={`rounded-2xl px-4 py-2 text-sm font-black border transition-colors ${
                  dashboardRole === "coordenador"
                    ? "bg-primary text-white border-primary"
                    : "bg-white text-slate-600 border-slate-200 hover:bg-slate-50"
                }`}
              >
            ...
            <Dashboard embeddedForRole={dashboardRole} />
          </TabsContent>
        )}
      </Tabs>
