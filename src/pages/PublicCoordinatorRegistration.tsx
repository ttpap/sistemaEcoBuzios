...
function getUrl() {
  try {
    return `${window.location.origin}/inscricao-coordenador`;
  } catch {
    return "/inscricao-coordenador";
  }
}

export default function PublicCoordinatorRegistration() {
        ...
        <div className="mt-8 grid gap-6 lg:grid-cols-3">
            ...
            <CardContent className="p-8">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h1 className="text-xl font-black text-primary tracking-tight">Cadastro de coordenador</h1>
                </div>
              </div>
              ...
              <div className="mt-6 space-y-3 text-sm font-medium text-slate-600">
                ...
                <p className="text-xs font-bold text-slate-500">
                  A senha padrão é <span className="font-black">{DEFAULT_COORDINATOR_PASSWORD}</span>.
                </p>
              </div>
          ...
          <div className="lg:col-span-2">
            {done ? (
              ...
              <CoordinatorForm redirectTo={null} onCompleted={(r) => setDone(r)} />
            )}
          </div>
        </div>
      </div>
