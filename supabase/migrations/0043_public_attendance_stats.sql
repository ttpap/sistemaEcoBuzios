-- Função pública para estatísticas de frequência mensal e anual
-- Usada pela Edge Function public-stats-api (service role, sem RLS)
...
-- Garante que o service role pode chamar a função
